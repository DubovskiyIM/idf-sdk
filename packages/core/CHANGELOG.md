...
- e7aa9c4: U-derive Phase 2 — 4 stable pattern bank entries для derived UI:
...
- cf05d02: feat(core): reader gap policy integration в voice + document materializers
...
- 1c4a109: feat(core): Φ schema-versioning Phase 5 — Layer 4 drift detector
...
- 6bd9e22: feat(core): Φ schema-versioning Phase 4 — Reader gap policy
...
- 4f0901a: feat(core): Φ schema-versioning Phase 3 — applyUpcaster + fold(upcast(Φ))
...
- 01c5b3b: feat(core): Φ schema-versioning Phase 2 — ontology.evolution[] лог
...
- b02f7a8: feat(core): Φ schema-versioning Phase 0 foundation
...
- 6fa50bd: feat(crystallize_v2): default-flip tier-driven slot routing — opt-in → opt-out
...
- 1a4f581: feat(crystallize_v2): generalize tier routing к classifyIntentRole consultation
...
- ed676b5: fix(patterns): catalog-creator-toolbar дедуплицирует с tier-routing hero promotion
